...
set_FORM_option allow_external_momenta_isomorphic_mapping False
set_alphaLoop_option FORM_compile_cores 40
set_FORM_option cores 20
#set_FORM_option max_n_lines_in_C_source 300
...
set_FORM_option reference_lmb {}
set_qgraf_spoof ./PLUGIN/new_aL_deformation/aa_ttx_assets/graphs/NNLO_only_four_tops_graphs.py
#set_FORM_option reference_lmb {\
#"GL144":['pq1','pq3','pq5'],\
#"GL146":['pq1','pq3','pq5'],\
#"GL148":['pq1','pq3','pq9'],\
...
#}
define j = j t t~
qgraf_generate  a a > t t~ t t~ / u d s c b QCD^2==1 QED^2==2 [QCD]
!rm -rf /shared/vhirschi/aa_ttx/runs/NNLO_only_four_tops_graphs
output qgraf /shared/vhirschi/aa_ttx/runs/NNLO_only_four_tops_graphs
