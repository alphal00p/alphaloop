...
set_qgraf_spoof ./PLUGIN/new_aL_deformation/aa_ttx_assets/graphs/NNLO_from_gL__singlet__valid_lmb.py
qgraf_generate  a a > t t~ t t~ / u d s c b QCD^2==1 QED^2==2 [QCD]
!rm -rf /shared/vhirschi/aa_ttx/runs/NNLO_from_gL__singlet__four_tops_valid_lmb
output qgraf /shared/vhirschi/aa_ttx/runs/NNLO_from_gL__singlet__four_tops_valid_lmb
