...
Labeled[Style[CreateEdge["1","4",1],Blue,Thickness[0.002000]],"\!\(\*OverscriptBox[\(t\), \(_\)]\)|q2|p2"],
...
Labeled[Style[CreateEdge["3","4",5],Blue,Thickness[0.002000]],"t|pq1|p1-p2-p1+k1"],
Labeled[Style[CreateEdge["4","7",2],Red,Thickness[0.005000]],"g|pq2|k1"],
Labeled[Style[CreateEdge["3","7",0],Red,Thickness[0.002000]],"g|pq3|p2+p1-k1"]
},
EdgeShapeFunction -> {
...
CreateEdge["3","7",0]->GraphElementData["Arrow", "ArrowSize" -> 0.015000]
},
...
Export["Graph_000002.pdf", GraphicsGrid[{{aGraph}}], ImageSize -> {825.000000, 637.500000}];