...
diagrams_python_source_QG = './ggHHHsgs.py'

# |================================================================================================
# || Results for process gg > hhh (Loop-induced)
# |================================================================================================
...
# |  5.0000000000000000e+02  0.0000000000000000e+00  0.0000000000000000e+00 -5.0000000000000000e+02
# |  4.3855556622469447e+02  1.5533220018353771e+02  3.4801603965135871e+02 -1.7737736157184131e+02
# |  3.5636963749219228e+02 -1.6802389008511000e+01 -3.1872911024360042e+02  9.7487191636880993e+01
# |  2.0507479628311330e+02 -1.3852981117502671e+02 -2.9286929407758191e+01  7.9890169934960298e+01
# |
# | Stable kinematic configuration (SPS).
# | Estimated relative accuracy = 7.2e-13
# |
# || Loop amplitude squared, must be finite:
# |    Finite      =  3.7434703046159719e-10
# |(| Pole residues, indicated only for checking purposes: )
# |(    Single pole =  0.0000000000000000e+00 )
# |(    Double pole =  0.0000000000000000e+00 )
# |
# |
# || All virtual contributions are of split orders *(QCD=4 QED=6)
# |================================================================================================
...
cut_momentum ={
    'c1':[4.3855556622469447e+02,  1.5533220018353771e+02,  3.4801603965135871e+02, -1.7737736157184131e+02],
    'c2':[3.5636963749219228e+02, -1.6802389008511000e+01, -3.1872911024360042e+02,  9.7487191636880993e+01]
    }
...
super_graphs_list = FORMSuperGraphList.from_dict(
    ...
    external_mom=external_momenta,fixed_cut_mom=cut_momentum,num_fixed_loops=2,is_scalar=True)
