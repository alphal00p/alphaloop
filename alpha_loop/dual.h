...
public:
  ...
  dual(const dual<X> & x)
    : _real((T)x.rpart()), _dual((T)x.dpart()) {}
  ...
  dual<T> operator+(const T & x) const { return dual<T>(_real + x, _dual); }
  dual<T> operator-(const T & x) const { return dual<T>(_real - x, _dual); }
  dual<T> operator*(const T & x) const { return dual<T>(_real * x, _dual * x); }
  dual<T> operator/(const T & x) const { return dual<T>(_real / x, _dual / x); }
