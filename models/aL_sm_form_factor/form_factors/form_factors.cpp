...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * astu/(96.0*xs*xs*xt*xt*xu*xu);
}
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * astu/(96.0*xs*xs*xt*xt*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * astu/(96.0*xs*xs*xt*xt*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * atsu/(96.0*xs*xs*xt*xt*xu*xu);
}
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * atsu/(96.0*xs*xs*xt*xt*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * atsu/(96.0*xs*xs*xt*xt*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * aust/(96.0*xs*xs*xt*xt*xu*xu);
}
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * aust/(96.0*xs*xs*xt*xt*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * aust/(96.0*xs*xs*xt*xt*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * bstu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);
}
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * bstu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * bstu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * btsu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);
}
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * btsu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * btsu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * bust/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);
}
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * bust/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * bust/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * cstu/(3.0*xs*xs*xs*xs*xt*xt*xt*xt*xu*xu*xu*xu);
}
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * cstu/(3.0*xs*xs*xs*xs*xt*xt*xt*xt*xu*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * cstu/(3.0*xs*xs*xs*xs*xt*xt*xt*xt*xu*xu*xu*xu);*out = (*out).conj();
*out = (*out).conj();
}
