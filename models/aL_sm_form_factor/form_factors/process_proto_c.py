...
common_denominators = ["(96.0*xs*xs*xt*xt*xu*xu)","(96.0*xs*xs*xt*xt*xu*xu)","(96.0*xs*xs*xt*xt*xu*xu)", "(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu)","(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu)","(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu)","(3.0*xs*xs*xs*xs*xt*xt*xt*xt*xu*xu*xu*xu)"]
...
for i in range(len(file_names)):
    ...
    for float_type in zip(types, type_labels):
        ...
        main_code += "\n{\n"
        main_code += "\t {0} s,t,u;".format(float_type[0])
