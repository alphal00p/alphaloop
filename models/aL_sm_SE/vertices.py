...
Vdummy = Vertex(name = 'Vdummy',
              particles = [ P.a, P.aPrime, P.sDummy ],
              color = [ '1' ],
              lorentz = [ L.VVS ],
              couplings = {(0,0):C.GDummy})

VdummyT = Vertex(name = 'VdummyT',
              particles = [ P.tPrime__tilde__, P.t, P.sDummy ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS ],
              couplings = {(0,0):C.GDummy})
