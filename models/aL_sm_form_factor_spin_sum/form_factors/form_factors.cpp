...
void FFUINV_mpfr(mppp::complex p1_p1, mppp::complex p2_p2, mppp::complex p1_p2,
                 mppp::complex *out) {
  *out = 1.0 / (p1_p1 + p2_p2 + 2.0 * p1_p2);
}void APHOAMPFFSTU_f64(complex<double> E1,
                       complex<double> E2,
                       complex<double> E3,
                       ...
                       complex<double>* out)
{
	...
	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &s_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	complex<double> d02su = (complex<double>)rslt[0]*M_f64*M_f64*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &s_f64, &t_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	complex<double> d02st = (complex<double>)rslt[0]*M_f64*M_f64*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &t_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	complex<double> d02tu = (complex<double>)rslt[0]*M_f64*M_f64*M_f64*M_f64;
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * astu/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*s*s);
}
void APHOAMPFFSTU_f128(complex128 E1,
                       complex128 E2,
                       complex128 E3,
                       complex128 p1_p2,
                       complex128 p1_p3,
                       ...
                       complex128* out)
{
	 complex128 s,t,u,E4,E12,E22,E32,E42;
	 complex<double> s_f64, t_f64, u_f64;
	 complex128 xs,xt,xu;
	 ...
	 complex<double> rslt[3];
	OLO_B0cc(&rslt, &s_f64, &M2_f64, &M2_f64);
	complex128 b02s = (complex128)rslt[0]*1.0;

	OLO_B0cc(&rslt, &t_f64, &M2_f64, &M2_f64);
	complex128 b02t = (complex128)rslt[0]*1.0;

	OLO_B0cc(&rslt, &u_f64, &M2_f64, &M2_f64);
	complex128 b02u = (complex128)rslt[0]*1.0;

	OLO_C0cc(&rslt, &zero_f64, &zero_f64, &s_f64, &M2_f64, &M2_f64, &M2_f64);
	complex128 c02s = (complex128)rslt[0]*M_f64*M_f64;

	OLO_C0cc(&rslt, &zero_f64, &zero_f64, &t_f64, &M2_f64, &M2_f64, &M2_f64);
	complex128 c02t = (complex128)rslt[0]*M_f64*M_f64;

	OLO_C0cc(&rslt, &zero_f64, &zero_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64);
	complex128 c02u = (complex128)rslt[0]*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &s_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	complex128 d02su = (complex128)rslt[0]*M_f64*M_f64*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &s_f64, &t_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	complex128 d02st = (complex128)rslt[0]*M_f64*M_f64*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &t_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	complex128 d02tu = (complex128)rslt[0]*M_f64*M_f64*M_f64*M_f64;
...
astu = M_f128*M_f128*M_f128*M_f128*Z[0];
 
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * astu/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*s*s);
}
void APHOAMPFFSTU_mpfr(mppp::complex E1,
                       mppp::complex E2,
                       mppp::complex E3,
                       mppp::complex p1_p2,
                       mppp::complex p1_p3,
                       ...
                       mppp::complex* out)
{
	 mppp::complex s,t,u,E4,E12,E22,E32,E42;
	 complex<double> s_f64, t_f64, u_f64;
	 mppp::complex xs,xt,xu;
	 ...
	 complex<double> rslt[3];
	OLO_B0cc(&rslt, &s_f64, &M2_f64, &M2_f64);
	mppp::complex b02s = (mppp::complex)rslt[0]*1.0;

	OLO_B0cc(&rslt, &t_f64, &M2_f64, &M2_f64);
	mppp::complex b02t = (mppp::complex)rslt[0]*1.0;

	OLO_B0cc(&rslt, &u_f64, &M2_f64, &M2_f64);
	mppp::complex b02u = (mppp::complex)rslt[0]*1.0;

	OLO_C0cc(&rslt, &zero_f64, &zero_f64, &s_f64, &M2_f64, &M2_f64, &M2_f64);
	mppp::complex c02s = (mppp::complex)rslt[0]*M_f64*M_f64;

	OLO_C0cc(&rslt, &zero_f64, &zero_f64, &t_f64, &M2_f64, &M2_f64, &M2_f64);
	mppp::complex c02t = (mppp::complex)rslt[0]*M_f64*M_f64;

	OLO_C0cc(&rslt, &zero_f64, &zero_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64);
	mppp::complex c02u = (mppp::complex)rslt[0]*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &s_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	mppp::complex d02su = (mppp::complex)rslt[0]*M_f64*M_f64*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &s_f64, &t_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	mppp::complex d02st = (mppp::complex)rslt[0]*M_f64*M_f64*M_f64*M_f64;

	OLO_D0cc(&rslt, &zero_f64, &zero_f64, &zero_f64, &zero_f64, &t_f64, &u_f64, &M2_f64, &M2_f64, &M2_f64, &M2_f64);
	mppp::complex d02tu = (mppp::complex)rslt[0]*M_f64*M_f64*M_f64*M_f64;
...
astu = M_mpfr*M_mpfr*M_mpfr*M_mpfr*Z[0];
 
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * astu/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*s*s);
}
void APHOAMPFFTSU_f64(complex<double> E1,
                       complex<double> E2,
                       complex<double> E3,
                       complex<double> p1_p2,
                       complex<double> p1_p3,
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * atsu/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*t*t);
}
void APHOAMPFFTSU_f128(complex128 E1,
                       complex128 E2,
                       complex128 E3,
                       complex128 p1_p2,
                       complex128 p1_p3,
...
atsu = M_f128*M_f128*M_f128*M_f128*Z[0];
 
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * atsu/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*t*t);
}
void APHOAMPFFTSU_mpfr(mppp::complex E1,
                       mppp::complex E2,
                       mppp::complex E3,
                       mppp::complex p1_p2,
                       mppp::complex p1_p3,
...
atsu = M_mpfr*M_mpfr*M_mpfr*M_mpfr*Z[0];
 
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * atsu/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*t*t);
}
void APHOAMPFFUST_f64(complex<double> E1,
                       complex<double> E2,
                       complex<double> E3,
                       complex<double> p1_p2,
                       complex<double> p1_p3,
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * aust/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*u*u);
}
void APHOAMPFFUST_f128(complex128 E1,
                       complex128 E2,
                       complex128 E3,
                       complex128 p1_p2,
                       complex128 p1_p3,
...
aust = M_f128*M_f128*M_f128*M_f128*Z[0];
 
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * aust/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*u*u);
}
void APHOAMPFFUST_mpfr(mppp::complex E1,
                       mppp::complex E2,
                       mppp::complex E3,
                       mppp::complex p1_p2,
                       mppp::complex p1_p3,
...
aust = M_mpfr*M_mpfr*M_mpfr*M_mpfr*Z[0];
 
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * aust/(96.0*xs*xs*xt*xt*xu*xu*E1*E2*E3*E42*u*u);
}
void BPHOAMPFFSTU_f64(complex<double> E1,
                       complex<double> E2,
                       complex<double> E3,
                       complex<double> p1_p2,
                       complex<double> p1_p3,
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * bstu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E1*E2*E32*E42*s*s*t*t*u));
}
void BPHOAMPFFSTU_f128(complex128 E1,
                       complex128 E2,
                       complex128 E3,
                       complex128 p1_p2,
                       complex128 p1_p3,
...
bstu = M_f128*M_f128*Z[0];
 
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * bstu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E1*E2*E32*E42*s*s*t*t*u));
}
void BPHOAMPFFSTU_mpfr(mppp::complex E1,
                       mppp::complex E2,
                       mppp::complex E3,
                       mppp::complex p1_p2,
                       mppp::complex p1_p3,
...
bstu = M_mpfr*M_mpfr*Z[0];
 
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * bstu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E1*E2*E32*E42*s*s*t*t*u));
}
void BPHOAMPFFTSU_f64(complex<double> E1,
                       complex<double> E2,
                       complex<double> E3,
                       complex<double> p1_p2,
                       complex<double> p1_p3,
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * btsu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E12*E2*E3*E42*s*s*t*t*u));
}
void BPHOAMPFFTSU_f128(complex128 E1,
                       complex128 E2,
                       complex128 E3,
                       complex128 p1_p2,
                       complex128 p1_p3,
...
btsu = M_f128*M_f128*Z[0];
 
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * btsu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E12*E2*E3*E42*s*s*t*t*u));
}
void BPHOAMPFFTSU_mpfr(mppp::complex E1,
                       mppp::complex E2,
                       mppp::complex E3,
                       mppp::complex p1_p2,
                       mppp::complex p1_p3,
...
btsu = M_mpfr*M_mpfr*Z[0];
 
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * btsu/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E12*E2*E3*E42*s*s*t*t*u));
}
void BPHOAMPFFUST_f64(complex<double> E1,
                       complex<double> E2,
                       complex<double> E3,
                       complex<double> p1_p2,
                       complex<double> p1_p3,
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * bust/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E1*E22*E3*E42*s*s*t*u*u));
}
void BPHOAMPFFUST_f128(complex128 E1,
                       complex128 E2,
                       complex128 E3,
                       complex128 p1_p2,
                       complex128 p1_p3,
...
bust = M_f128*M_f128*Z[0];
 
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * bust/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E1*E22*E3*E42*s*s*t*u*u));
}
void BPHOAMPFFUST_mpfr(mppp::complex E1,
                       mppp::complex E2,
                       mppp::complex E3,
                       mppp::complex p1_p2,
                       mppp::complex p1_p3,
...
bust = M_mpfr*M_mpfr*Z[0];
 
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * bust/(48.0*xs*xs*xs*xt*xt*xt*xu*xu*xu*(E1*E22*E3*E42*s*s*t*u*u));
}
void CPHOAMPFFSTU_f64(complex<double> E1,
                       complex<double> E2,
                       complex<double> E3,
                       complex<double> p1_p2,
                       complex<double> p1_p3,
...
*out =  2.0*3.0*top_Q8_f64/(M_f64*M_f64*M_f64*M_f64*M_PI*M_PI) * cstu/(3.0*xs*xs*xs*xs*xt*xt*xt*xt*xu*xu*xu*xu*(E1*E2*E3*E4*s*t*t*u));
}
void CPHOAMPFFSTU_f128(complex128 E1,
                       complex128 E2,
                       complex128 E3,
                       complex128 p1_p2,
                       complex128 p1_p3,
                       ...
                       complex128* out)
{
	 ...
	 complex<double> rslt[3];
	OLO_A0c(&rslt, &M2_f64);
	complex128 a02 = (complex128)rslt[0]*1.0 / (M_f64 * M_f64);
	...
	OLO_B0cc(&rslt, &zero_f64, &M2_f64, &M2_f64);
	complex128 b020 = (complex128)rslt[0]*1.0;
...
*out =  2.0*3.0*top_Q8_f128/(M_f128*M_f128*M_f128*M_f128*M_PI*M_PI) * cstu/(3.0*xs*xs*xs*xs*xt*xt*xt*xt*xu*xu*xu*xu*(E1*E2*E3*E4*s*t*t*u));
}
void CPHOAMPFFSTU_mpfr(mppp::complex E1,
                       mppp::complex E2,
                       mppp::complex E3,
                       mppp::complex p1_p2,
                       mppp::complex p1_p3,
                       ...
                       mppp::complex* out)
{
	 ...
	 complex<double> rslt[3];
	OLO_A0c(&rslt, &M2_f64);
	mppp::complex a02 = (mppp::complex)rslt[0]*1.0 / (M_f64 * M_f64);
	...
	OLO_B0cc(&rslt, &zero_f64, &M2_f64, &M2_f64);
	mppp::complex b020 = (mppp::complex)rslt[0]*1.0;
...
*out =  2.0*3.0*top_Q8_mpfr/(M_mpfr*M_mpfr*M_mpfr*M_mpfr*M_PI*M_PI) * cstu/(3.0*xs*xs*xs*xs*xt*xt*xt*xt*xu*xu*xu*xu*(E1*E2*E3*E4*s*t*t*u));
}
