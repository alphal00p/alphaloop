...
*   flip the arguments if it is needed.
  ...
  #$ampeval = 0;
    ...
    -CPHOAMPFFSTU(energyselector.p1, energyselector.p2, energyselector.p3, p1.p2, p1.p3, p2.p3) * ffinternalmomenta(p1,p2,p3,p4) *  amp(lorentz[idx1], lorentz[idx2], lorentz[idx3], lorentz[idx4]);
...
*    p2(lorentz[idx2]))*(energyselector.p3*energyselector.p4*(2*p2.p3*2*p1.p3))
*
*    *ffguard(-(energyselector.p3*2*p2.p3*p1(lorentz[idx3])) + energyselector.p3*2*p1.p3*p2(lorentz[idx3]) + (energyselector.p1*2*p2.p3 - energyselector.p2*2*p1.p3)*p3(lorentz[idx3]))
*
*    *ffguard(-(energyselector.p4*2*p1.p2*p2(lorentz[idx4])) + energyselector.p4*2*p1.p3*p3(lorentz[idx4]) + (energyselector.p2*2*p1.p2 - energyselector.p3*2*p1.p3)*p4(lorentz[idx4]))
*    
*    +
*    ffguard(energyselector.p3*2*p1.p2*p1(lorentz[idx1]) - energyselector.p2*2*p1.p3*p1(lorentz[idx1]) + energyselector.p1*2*p1.p3*p2(lorentz[idx1]) - 
*    energyselector.p1*2*p1.p2*p3(lorentz[idx1]))
*    *ffguard(-(energyselector.p2*2*p2.p3*p1(lorentz[idx2])) - energyselector.p3*2*p1.p2*p2(lorentz[idx2]) + energyselector.p1*2*p2.p3*p2(lorentz[idx2]) + 
*    energyselector.p2*2*p1.p2*p3(lorentz[idx2]))
*    *ffguard(energyselector.p3^2*energyselector.p4^2*2*p2.p3*2*p1.p3*d_(lorentz[idx3], lorentz[idx4]) - energyselector.p3^2*energyselector.p4*2*p2.p3*2*p1.p3*p1(lorentz[idx3])*energyselector(lorentz[idx4]) - 
*    energyselector.p3^2*energyselector.p4*2*p2.p3*2*p1.p3*p2(lorentz[idx3])*energyselector(lorentz[idx4]) + 
*    energyselector.p1*energyselector.p3*energyselector.p4*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*energyselector(lorentz[idx4]) + 
*    energyselector.p2*energyselector.p3*energyselector.p4*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*energyselector(lorentz[idx4]) - 
*    energyselector.p3^2*energyselector.p4*2*p2.p3*2*p1.p3*p4(lorentz[idx3])*energyselector(lorentz[idx4]) - 
*    energyselector.p3*energyselector.p4^2*2*p2.p3*2*p1.p3*energyselector(lorentz[idx3])*p1(lorentz[idx4]) + 
*    2*energyselector.p3^2*energyselector.p4^2*2*p1.p3*p2(lorentz[idx3])*p1(lorentz[idx4]) - 
*    2*energyselector.p2*energyselector.p3*energyselector.p4^2*2*p1.p3*p3(lorentz[idx3])*p1(lorentz[idx4]) + 
*    energyselector.p4^2*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p1(lorentz[idx4]) - energyselector.p3*energyselector.p4^2*2*p2.p3*2*p1.p3*energyselector(lorentz[idx3])*
*    p2(lorentz[idx4]) + 2*energyselector.p3^2*energyselector.p4^2*2*p2.p3*p1(lorentz[idx3])*p2(lorentz[idx4]) - 
*    2*energyselector.p1*energyselector.p3*energyselector.p4^2*2*p2.p3*p3(lorentz[idx3])*p2(lorentz[idx4]) + 
*    energyselector.p4^2*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p2(lorentz[idx4]) - energyselector.p3*energyselector.p4^2*2*p2.p3*2*p1.p3*energyselector(lorentz[idx3])*
*    p3(lorentz[idx4]) + energyselector.p4^2*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p3(lorentz[idx4]) + 
*    energyselector.p1*energyselector.p3*energyselector.p4*2*p2.p3*2*p1.p3*energyselector(lorentz[idx3])*p4(lorentz[idx4]) + 
*    energyselector.p2*energyselector.p3*energyselector.p4*2*p2.p3*2*p1.p3*energyselector(lorentz[idx3])*p4(lorentz[idx4]) - 
*    2*energyselector.p2*energyselector.p3^2*energyselector.p4*2*p2.p3*p1(lorentz[idx3])*p4(lorentz[idx4]) + 
*    energyselector.p3^2*2*p2.p3*2*p1.p3*p1(lorentz[idx3])*p4(lorentz[idx4]) - 2*energyselector.p1*energyselector.p3^2*energyselector.p4*2*p1.p3*p2(lorentz[idx3])*
*    p4(lorentz[idx4]) + energyselector.p3^2*2*p2.p3*2*p1.p3*p2(lorentz[idx3])*p4(lorentz[idx4]) - 
*    2*energyselector.p1*energyselector.p2*energyselector.p3*energyselector.p4*2*p1.p2*p3(lorentz[idx3])*p4(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p3*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p4(lorentz[idx4]) - 
*    energyselector.p2*energyselector.p3*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p4(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p4*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p4(lorentz[idx4]) - 
*    energyselector.p2*energyselector.p4*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p4(lorentz[idx4]) - 
*    energyselector.p3*energyselector.p4*2*p2.p3*2*p1.p3*p3(lorentz[idx3])*p4(lorentz[idx4]) + 
...
*    2*p2.p3*p2(lorentz[idx2])*p3(lorentz[idx3]) - 2*energyselector.p2^2*p3(lorentz[idx2])*
*    p3(lorentz[idx3])) * (energyselector.p1*energyselector.p4*2*p1.p2*2*p1.p3)
*
*    *ffguard(energyselector.p3*2*p1.p2*p1(lorentz[idx1]) - energyselector.p2*2*p1.p3*p1(lorentz[idx1]) + energyselector.p1*2*p1.p3*p2(lorentz[idx1]) - 
*    energyselector.p1*2*p1.p2*p3(lorentz[idx1]))
*
*    *ffguard(energyselector.p4*2*p1.p3*p1(lorentz[idx4]) - energyselector.p4*2*p2.p3*p2(lorentz[idx4]) + energyselector.p2*2*p2.p3*p4(lorentz[idx4]) - 
*    energyselector.p1*2*p1.p3*p4(lorentz[idx4]))
*    +
*    ffguard(-(energyselector.p3*2*p2.p3*p1(lorentz[idx3])) + energyselector.p3*2*p1.p3*p2(lorentz[idx3]) + energyselector.p1*2*p2.p3*p3(lorentz[idx3]) - 
*    energyselector.p2*2*p1.p3*p3(lorentz[idx3]))*(2*p2.p3)
*
*    *ffguard(energyselector.p2*2*p2.p3*p1(lorentz[idx2]) + energyselector.p3*2*p1.p2*p2(lorentz[idx2]) - energyselector.p1*2*p2.p3*p2(lorentz[idx2]) - 
*    energyselector.p2*2*p1.p2*p3(lorentz[idx2]))
*
*    *ffguard(energyselector.p1^2*energyselector.p4^2*2*p1.p2*2*p1.p3*d_(lorentz[idx1], lorentz[idx4]) + energyselector.p1*energyselector.p2*energyselector.p4*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*energyselector(lorentz[idx4]) + 
*    energyselector.p1*energyselector.p3*energyselector.p4*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*energyselector(lorentz[idx4]) - 
*    energyselector.p1^2*energyselector.p4*2*p1.p2*2*p1.p3*p2(lorentz[idx1])*energyselector(lorentz[idx4]) - 
*    energyselector.p1^2*energyselector.p4*2*p1.p2*2*p1.p3*p3(lorentz[idx1])*energyselector(lorentz[idx4]) - 
*    energyselector.p1^2*energyselector.p4*2*p1.p2*2*p1.p3*p4(lorentz[idx1])*energyselector(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p4^2*2*p1.p2*2*p1.p3*energyselector(lorentz[idx1])*p1(lorentz[idx4]) + 
*    energyselector.p4^2*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p1(lorentz[idx4]) - energyselector.p1*energyselector.p4^2*2*p1.p2*2*p1.p3*energyselector(lorentz[idx1])*
*    p2(lorentz[idx4]) - 2*energyselector.p1*energyselector.p3*energyselector.p4^2*2*p1.p2*p1(lorentz[idx1])*p2(lorentz[idx4]) + 
*    energyselector.p4^2*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p2(lorentz[idx4]) + 2*energyselector.p1^2*energyselector.p4^2*2*p1.p2*p3(lorentz[idx1])*
*    p2(lorentz[idx4]) - energyselector.p1*energyselector.p4^2*2*p1.p2*2*p1.p3*energyselector(lorentz[idx1])*p3(lorentz[idx4]) - 
*    2*energyselector.p1*energyselector.p2*energyselector.p4^2*2*p1.p3*p1(lorentz[idx1])*p3(lorentz[idx4]) + 
*    energyselector.p4^2*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p3(lorentz[idx4]) + 2*energyselector.p1^2*energyselector.p4^2*2*p1.p3*p2(lorentz[idx1])*
*    p3(lorentz[idx4]) + energyselector.p1*energyselector.p2*energyselector.p4*2*p1.p2*2*p1.p3*energyselector(lorentz[idx1])*p4(lorentz[idx4]) + 
*    energyselector.p1*energyselector.p3*energyselector.p4*2*p1.p2*2*p1.p3*energyselector(lorentz[idx1])*p4(lorentz[idx4]) - 
*    2*energyselector.p1*energyselector.p2*energyselector.p3*energyselector.p4*2*p2.p3*p1(lorentz[idx1])*p4(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p2*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p4(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p3*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p4(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p4*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p4(lorentz[idx4]) - 
*    energyselector.p2*energyselector.p4*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p4(lorentz[idx4]) - 
*    energyselector.p3*energyselector.p4*2*p1.p2*2*p1.p3*p1(lorentz[idx1])*p4(lorentz[idx4]) - 
*    2*energyselector.p1^2*energyselector.p3*energyselector.p4*2*p1.p3*p2(lorentz[idx1])*p4(lorentz[idx4]) + 
*    energyselector.p1^2*2*p1.p2*2*p1.p3*p2(lorentz[idx1])*p4(lorentz[idx4]) - 2*energyselector.p1^2*energyselector.p2*energyselector.p4*2*p1.p2*p3(lorentz[idx1])*
...
*    2*p1.p3*p1(lorentz[idx1])*p3(lorentz[idx3]) - 2*energyselector.p1^2*p3(lorentz[idx1])*
*    p3(lorentz[idx3]))*(energyselector.p2*energyselector.p4*2*p1.p2*2*p2.p3)
*
*    *ffguard(energyselector.p2*2*p2.p3*p1(lorentz[idx2]) + energyselector.p3*2*p1.p2*p2(lorentz[idx2]) - energyselector.p1*2*p2.p3*p2(lorentz[idx2]) - 
*    energyselector.p2*2*p1.p2*p3(lorentz[idx2]))
*
...
*    +
*    ffguard(energyselector.p3*2*p2.p3*p1(lorentz[idx3]) - energyselector.p3*2*p1.p3*p2(lorentz[idx3]) - energyselector.p1*2*p2.p3*p3(lorentz[idx3]) + 
*    energyselector.p2*2*p1.p3*p3(lorentz[idx3]))*(2*p1.p3)
*
*    *ffguard(energyselector.p3*2*p1.p2*p1(lorentz[idx1]) - energyselector.p2*2*p1.p3*p1(lorentz[idx1]) + energyselector.p1*2*p1.p3*p2(lorentz[idx1]) - 
*    energyselector.p1*2*p1.p2*p3(lorentz[idx1]))
*
*    *ffguard(energyselector.p2^2*energyselector.p4^2*2*p1.p2*2*p2.p3*d_(lorentz[idx2], lorentz[idx4]) - energyselector.p2^2*energyselector.p4*2*p1.p2*2*p2.p3*p1(lorentz[idx2])*energyselector(lorentz[idx4]) + 
*    energyselector.p1*energyselector.p2*energyselector.p4*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*energyselector(lorentz[idx4]) + 
*    energyselector.p2*energyselector.p3*energyselector.p4*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*energyselector(lorentz[idx4]) - 
*    energyselector.p2^2*energyselector.p4*2*p1.p2*2*p2.p3*p3(lorentz[idx2])*energyselector(lorentz[idx4]) - 
*    energyselector.p2^2*energyselector.p4*2*p1.p2*2*p2.p3*p4(lorentz[idx2])*energyselector(lorentz[idx4]) - 
*    energyselector.p2*energyselector.p4^2*2*p1.p2*2*p2.p3*energyselector(lorentz[idx2])*p1(lorentz[idx4]) - 
*    2*energyselector.p2*energyselector.p3*energyselector.p4^2*2*p1.p2*p2(lorentz[idx2])*p1(lorentz[idx4]) + 
*    energyselector.p4^2*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p1(lorentz[idx4]) + 2*energyselector.p2^2*energyselector.p4^2*2*p1.p2*p3(lorentz[idx2])*
*    p1(lorentz[idx4]) - energyselector.p2*energyselector.p4^2*2*p1.p2*2*p2.p3*energyselector(lorentz[idx2])*p2(lorentz[idx4]) + 
*    energyselector.p4^2*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p2(lorentz[idx4]) - energyselector.p2*energyselector.p4^2*2*p1.p2*2*p2.p3*energyselector(lorentz[idx2])*
*    p3(lorentz[idx4]) + 2*energyselector.p2^2*energyselector.p4^2*2*p2.p3*p1(lorentz[idx2])*p3(lorentz[idx4]) - 
*    2*energyselector.p1*energyselector.p2*energyselector.p4^2*2*p2.p3*p2(lorentz[idx2])*p3(lorentz[idx4]) + 
*    energyselector.p4^2*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p3(lorentz[idx4]) + energyselector.p1*energyselector.p2*energyselector.p4*2*p1.p2*2*p2.p3*energyselector(lorentz[idx2])*
*    p4(lorentz[idx4]) + energyselector.p2*energyselector.p3*energyselector.p4*2*p1.p2*2*p2.p3*energyselector(lorentz[idx2])*p4(lorentz[idx4]) - 
*    2*energyselector.p2^2*energyselector.p3*energyselector.p4*2*p2.p3*p1(lorentz[idx2])*p4(lorentz[idx4]) + 
*    energyselector.p2^2*2*p1.p2*2*p2.p3*p1(lorentz[idx2])*p4(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p2*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p4(lorentz[idx4]) - 
*    energyselector.p2*energyselector.p3*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p4(lorentz[idx4]) - 
*    energyselector.p1*energyselector.p4*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p4(lorentz[idx4]) - 
*    energyselector.p2*energyselector.p4*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p4(lorentz[idx4]) - 
*    energyselector.p3*energyselector.p4*2*p1.p2*2*p2.p3*p2(lorentz[idx2])*p4(lorentz[idx4]) - 
*    2*energyselector.p1*energyselector.p2*energyselector.p3*energyselector.p4*2*p1.p3*p2(lorentz[idx2])*p4(lorentz[idx4]) - 
*    2*energyselector.p1*energyselector.p2^2*energyselector.p4*2*p1.p2*p3(lorentz[idx2])*p4(lorentz[idx4]) + 
*    energyselector.p2^2*2*p1.p2*2*p2.p3*p3(lorentz[idx2])*p4(lorentz[idx4]) + 
