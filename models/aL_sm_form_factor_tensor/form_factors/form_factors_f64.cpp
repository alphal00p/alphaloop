...
complex<double> bstu_polynomial(polynomial_parameters p_a) {
  ...
  Z[5] = -Z[4] - Z[7];
  Z[6] =
      18.0 * p_a.c02u + 36.0 * p_a.c02s - 16.0 * p_a.d02su + p_a.b02u + Z[25];
...
complex<double> btsu_polynomial(polynomial_parameters p_a) {
  ...
  Z[4] = 2.0 * p_a.b02s;
  Z[5] = -Z[4] - Z[7];
  Z[6] = 18.0 * p_a.c02u + 36.0 * p_a.c02t - 16.0 * p_a.d02tu + Z[24] +
         p_a.b02u + 3.0 * p_a.b02s;
...
complex<double> bust_polynomial(polynomial_parameters p_a) {
  ...
  Z[4] = 2.0 * p_a.b02s;
  Z[5] = -Z[4] - Z[12];
  Z[6] = 36.0 * p_a.c02u + 18.0 * p_a.c02t - 16.0 * p_a.d02tu + Z[25] +
         p_a.b02t + 3.0 * p_a.b02s;
...
complex<double> cstu_polynomial(polynomial_parameters p_a) {
  ...
  Z[21] = -Z[4] - Z[20];
  Z[21] = Z[21] * Z[0];
  Z[21] = Z[21] + 30.0 * p_a.c02u - 18.0 * p_a.d02su + 13.0 * p_a.b02u +
          12.0 * p_a.c02s;
  Z[21] = p_a.xu * Z[21];
  Z[19] = 2.0 * Z[19] + Z[21];
...
AmpTensor_f64::AmpTensor_f64(LorentzVector<complex<double>> mom_1,
                             LorentzVector<complex<double>> mom_2,
                             LorentzVector<complex<double>> mom_3,
                             LorentzVector<complex<double>> mom_4) {
  complex<double> f_astu;
  complex<double> f_atsu;
  complex<double> f_aust;
  complex<double> f_bstu;
  complex<double> f_btsu;
  complex<double> f_bust;
  complex<double> f_cstu;

  complex<double> p1_p2 = mom_1.dot(mom_2);
  complex<double> p2_p3 = mom_2.dot(mom_3);
  complex<double> p1_p3 = mom_3.dot(mom_1);

  APHOAMPFFSTU_f64(mom_1.t, mom_2.t, mom_3.t, p1_p2, p1_p3, p2_p3, &f_astu);
  APHOAMPFFTSU_f64(mom_1.t, mom_2.t, mom_3.t, p1_p2, p1_p3, p2_p3, &f_atsu);
  APHOAMPFFUST_f64(mom_1.t, mom_2.t, mom_3.t, p1_p2, p1_p3, p2_p3, &f_aust);
  BPHOAMPFFSTU_f64(mom_1.t, mom_2.t, mom_3.t, p1_p2, p1_p3, p2_p3, &f_bstu);
  BPHOAMPFFTSU_f64(mom_1.t, mom_2.t, mom_3.t, p1_p2, p1_p3, p2_p3, &f_btsu);
  BPHOAMPFFUST_f64(mom_1.t, mom_2.t, mom_3.t, p1_p2, p1_p3, p2_p3, &f_bust);
  CPHOAMPFFSTU_f64(mom_1.t, mom_2.t, mom_3.t, p1_p2, p1_p3, p2_p3, &f_cstu);

  amp_tensor_f64 =
      AmpTensor<complex<double>>(mom_1, mom_2, mom_3, mom_4, f_astu, f_atsu,
                                 f_aust, f_bstu, f_btsu, f_bust, f_cstu);
}

void AmpTensor_f64::amp_f64(LorentzVector<complex<double>> mom_1,
                            LorentzVector<complex<double>> mom_2,
                            LorentzVector<complex<double>> mom_3,
                            LorentzVector<complex<double>> mom_4,
                            complex<double> *out) {
  *out = amp_tensor_f64.amp(SpatialVector<complex<double>>(mom_1),
                            SpatialVector<complex<double>>(mom_2),
                            SpatialVector<complex<double>>(mom_3),
                            SpatialVector<complex<double>>(mom_4));
}

void AmpTensor_f64::amp12_f64(LorentzVector<complex<double>> mom_3,
                              LorentzVector<complex<double>> mom_4,
                              complex<double> *out) {
  *out = amp_tensor_f64.amp12(SpatialVector<complex<double>>(mom_3),
                              SpatialVector<complex<double>>(mom_4));
}

void AmpTensor_f64::amp13_f64(LorentzVector<complex<double>> mom_2,
                              LorentzVector<complex<double>> mom_4,
                              complex<double> *out) {
  *out = amp_tensor_f64.amp13(SpatialVector<complex<double>>(mom_2),
                              SpatialVector<complex<double>>(mom_4));
}

void AmpTensor_f64::amp14_f64(LorentzVector<complex<double>> mom_2,
                              LorentzVector<complex<double>> mom_3,
                              complex<double> *out) {
  *out = amp_tensor_f64.amp14(SpatialVector<complex<double>>(mom_2),
                              SpatialVector<complex<double>>(mom_3));
}

void AmpTensor_f64::amp23_f64(LorentzVector<complex<double>> mom_1,
                              LorentzVector<complex<double>> mom_4,
                              complex<double> *out) {
  *out = amp_tensor_f64.amp23(SpatialVector<complex<double>>(mom_1),
                              SpatialVector<complex<double>>(mom_4));
}

void AmpTensor_f64::amp24_f64(LorentzVector<complex<double>> mom_1,
                              LorentzVector<complex<double>> mom_3,
                              complex<double> *out) {
  *out = amp_tensor_f64.amp24(SpatialVector<complex<double>>(mom_1),
                              SpatialVector<complex<double>>(mom_3));
}

void AmpTensor_f64::amp34_f64(LorentzVector<complex<double>> mom_1,
                              LorentzVector<complex<double>> mom_2,
                              complex<double> *out) {
  *out = amp_tensor_f64.amp34(SpatialVector<complex<double>>(mom_1),
                              SpatialVector<complex<double>>(mom_2));
}
