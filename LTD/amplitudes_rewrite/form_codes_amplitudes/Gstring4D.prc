#procedure Gstring4D(G,par)
*   This is a 4D-adaption of Bens gstring routine: ep is replaced by 0 everywhere
*
...
id,ifmatch->easycatch,`G'(mu?,mu?,?b)=`G'(?b)*4;
id,ifmatch->easycatch,`G'(mu?,mu1?,mu?,?b)=-2*`G'(mu1,?b);
*
...
id,ifmatch->easycatch,`G'(?a,mu?,mu?,?b)=`G'(?a,?b)*4;
id,ifmatch->easycatch,`G'(?a,mu?,mu1?,mu?,?b)=-2*`G'(?a,mu1,?b);
*
*	Now the matches that generate two terms
*
