...
set label "Results for 4-point multi-loop scalar diagrams" font ",10" at graph 0.0, graph 0.92 offset 7.0,-0.2
set xrange [-7.:100.]
set yrange [1.1:6]
set origin 0.00, 0.5
set size 1, 0.2
...
set mxtics 4
set mytics 5
set ylabel "Integral [GeV^{-2(l+1)}]" offset 0, 0 font ",10"
set ytics 1 font ",10"
#set xtics nomirror
#set logscale y
#set logscale x
...
set ytics 1 font ",10"
set mytics 2
set ylabel "Deviation [%]" offset 0, 0 font ",10"
#set bmargin 0 
#set tmargin 0
#set mytics 5
##set xtics nomirror
...
set ylabel "Deviation [{/Symbol s}]" offset 0, 0 font ",10"
#set bmargin 0 
#set tmargin 0
#set mytics 5
##set xtics nomirror
